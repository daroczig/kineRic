...
Use the [AWR.Kinesis](https://github.com/cardcorp/AWR.Kinesis) package instead, which uses the `jar` files bundled with the [AWR](https://gitlab.com/cardcorp/AWR) package.
